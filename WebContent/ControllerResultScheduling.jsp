...
<body>
	...
	%>
	<div class="top1">
		<p style="margin-left:30px;color:#e7e9f4">Schedule Results > Year <%=year%> > Sem <%=new AcadYearDao().getSemester(year)%></p>
	</div>
	...
	<div class="vertical_menu_bar">
		...
		<form action="ControllerResultScheduling.jsp">
			<input type="hidden" name="year" value="1">
		    <input class="options" style="top:500px;padding:17px 85px 17px 57px;border:none;cursor:pointer;background-color:#16181d;color:#80b5eb" type="Submit" value="Results"></br>
		</form>
	...
	<div class="body_bar">
		...
		<div style="width:40%;position:absolute;top:100px;left:27%">
			<table id="tb">
				<tr>
					<th>Exam</th>
					<th>Open Date</th>
					...
					for(int j = 0; j < 3; j++){
						...
						String openDatePH = "NA";
						if(examTask != null){
							if(examTask.getResultOpenDate() != null) openDatePH = examTask.getResultOpenDate();
						}	
					%>
				<tr>
