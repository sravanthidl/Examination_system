...
<body>
	...
	<div class="top1">
		<p style="margin-left:30px;color:#e7e9f4">Schedule Exams > Year <%=year%> > Sem <%=new AcadYearDao().getSemester(year)%> > <%=examType%></p>
	</div>
	
	<div class="top2">
		<a style="position:absolute;top:20px;left:32px;background-color:#7382c8;color:#e7e9f4" href="ControllerExamSchedulingDashboard.jsp">&lt Back</a>
	</div>
